...
Example call for aether in this context once installed - calling from this directory `aether pipeline start base-pipeline-config.yml queries/example-crtdl.json`
